...
const RESOURCES_DATA = [
  { id: 'study', emoji: '📖', titleKey: 'resources_cat_study', items: [
    ...
    { name: 'QuranO', url: 'https://qurano.com', emoji: '🌐',
      en: 'Word-by-word Quran & tafsir in 15 languages', bn: '১৫টি ভাষায় শব্দে-শব্দে কুরআন অনুবাদ ও তাফসির (তামিল, মালয়ালম, হিন্দি সহ)' },
    { name: 'Visual Quran', url: 'https://visualquran.info', emoji: '📊',
      en: 'Interactive Quran infographics, structure & statistics', bn: 'কুরআনের গঠন ও পরিসংখ্যানের ইন্টারেক্টিভ ইনফোগ্রাফিক' },
  ...
  { id: 'tafsir', emoji: '📚', titleKey: 'resources_cat_tafsir', items: [
    ...
    { name: 'Quran Malayalam', url: 'https://quranmalayalam.com/quran/', emoji: '📖',
      en: 'Malayalam Quran translation, Amani tafsir & audio', bn: 'মালয়ালম কুরআন অনুবাদ, আমানি তাফসির ও অডিও' },
    { name: 'Tamil Il Quran', url: 'https://www.tamililquran.com', emoji: '📗',
      en: 'Tamil Quran word-by-word, Ibn Kathir tafsir & audio', bn: 'তামিল কুরআন শব্দে-শব্দে, ইবনে কাসির তাফসির ও অডিও' },
    { name: 'Surah.my (Malay)', url: 'https://www.surah.my', emoji: '🇲🇾',
      en: 'Malay Quran translation reference (since 2007)', bn: 'মালয় ভাষায় কুরআন অনুবাদ' },
  ] },
  { id: 'audio', emoji: '🎧', titleKey: 'resources_cat_audio', items: [
    ...
    { name: 'IslamicFinder Quran', url: 'https://www.islamicfinder.org/quran/', emoji: '🔊',
      en: 'Quran audio & translation in 40+ languages', bn: '৪০+ ভাষায় কুরআন অডিও, অনুবাদ ও অনুসন্ধান' },
    { name: 'Quran Pro', url: 'https://islam.quanticapps.com/en/apps/quran-islamic-mobile-app/', emoji: '🎧',
      en: 'Free app: huge reciter library, offline, 30 languages', bn: 'ফ্রি অ্যাপ, বিশাল কারী সংগ্রহ, অফলাইন, ৩০ ভাষা' },
  ...
  { id: 'dua', emoji: '🤲', titleKey: 'resources_cat_dua', items: [
    ...
    { name: 'Tasbih.org', url: 'https://www.tasbih.org', emoji: '🔢',
      en: 'Free online tasbih dhikr tally counter', bn: 'ফ্রি অনলাইন তাসবিহ যিকির গণনা যন্ত্র' },
  ] },
  ...
  { id: 'courses', emoji: '🎓', titleKey: 'resources_cat_courses', items: [
    { name: 'SeekersGuidance Quran Tafsir', url: 'https://academy.seekersguidance.org/enrol/index.php?id=552', emoji: '📖',
      en: 'Free complete Quran tafsir in short scholar-led lessons', bn: 'স্কলারদের সংক্ষিপ্ত পাঠে বিনামূল্যে সম্পূর্ণ কুরআন তাফসির' },
    ...
    { name: 'Introduction to the Quran (Notre Dame, edX)', url: 'https://www.edx.org/learn/islam/university-of-notre-dame-introduction-to-the-quran-the-scripture-of-islam', emoji: '🎓',
      en: 'Notre Dame university Quran course, free to audit', bn: 'নটর ডেম বিশ্ববিদ্যালয়ের কুরআন কোর্স, বিনামূল্যে অডিট' },
    ...
    { name: "The Birmingham Qur'an (FutureLearn)", url: 'https://www.futurelearn.com/courses/birmingham-quran', emoji: '📜',
      en: 'Birmingham University course on ancient Quran manuscript', bn: 'প্রাচীন কুরআন পাণ্ডুলিপি নিয়ে বার্মিংহাম বিশ্ববিদ্যালয়ের কোর্স' },
  ] },
  { id: 'academic', emoji: '📜', titleKey: 'resources_cat_academic', items: [
    { name: 'Encyclopedia of Variant Readings (EvQ)', url: 'https://digitalhumanities.fas.harvard.edu/projects/evq/', emoji: '📖',
      en: 'Harvard open encyclopedia of Quranic variant readings', bn: 'কুরআনের কিরাআত পাঠের হার্ভার্ড ওপেন এনসাইক্লোপিডিয়া' },
    ...
    { name: 'Digital Mushaf Project (Bodleian)', url: 'https://digitalmushaf.bodleian.ox.ac.uk', emoji: '🧩',
      en: 'Oxford reconstructs dispersed early Quran manuscript folios', bn: 'অক্সফোর্ডের বিক্ষিপ্ত প্রাচীন কুরআন পাণ্ডুলিপি পুনর্গঠন' },
    ...
    { name: "GloQur — The Global Qur'an", url: 'https://gloqur.de', emoji: '🌍',
      en: 'Scholarly research on worldwide Quran translations', bn: 'বিশ্বব্যাপী কুরআন অনুবাদ নিয়ে গবেষণা প্রকল্প' },
    ...
    { name: 'Sapience Institute', url: 'https://www.sapienceinstitute.org/read/', emoji: '💡',
      en: 'Intellectual answers to doubts about Islam', bn: 'ইসলাম নিয়ে সংশয়ের বুদ্ধিবৃত্তিক উত্তর' },
  ...
  { id: 'dev', emoji: '🛠️', titleKey: 'resources_cat_dev', items: [
    ...
    { name: 'fawazahmed0 Quran API', url: 'https://github.com/fawazahmed0/quran-api', emoji: '🔌',
      en: 'Free CDN Quran API: 90+ languages, 440+ translations', bn: 'ফ্রি সিডিএন কুরআন API: ৯০+ ভাষা, ৪৪০+ অনুবাদ' },
    ...
    { name: 'Amiri Font', url: 'https://aliftype.com/amiri/', emoji: '🔤',
      en: 'Classical Naskh Arabic font, free SIL license', bn: 'ধ্রুপদী নাসখ আরবি ফন্ট, ফ্রি SIL লাইসেন্স' },
    { name: 'Scheherazade New', url: 'https://software.sil.org/scheherazade/', emoji: '✒️',
      en: 'SIL Naskh Arabic font supporting Quranic text', bn: 'কুরআনি টেক্সট সমর্থনকারী SIL নাসখ আরবি ফন্ট' },
    ...
    { name: 'Tafsir API (spa5k)', url: 'https://github.com/spa5k/tafsir_api', emoji: '📚',
      en: 'Free tafsir API, 120+ commentaries, no limits', bn: 'বিনামূল্যে তাফসির API, ১২০+ তাফসির, সীমাহীন' },
  ] },
