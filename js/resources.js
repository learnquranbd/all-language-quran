...
const RESOURCES_DATA = [
  { id: 'study', emoji: '📖', titleKey: 'resources_cat_study', items: [
    ...
    { name: 'King Fahd Quran Complex', url: 'https://qurancomplex.gov.sa/en/', emoji: '📗',
      en: 'Official Madinah Mushaf editions & riwayat downloads', bn: 'মদিনা মুসহাফের অফিসিয়াল সংস্করণ ও রেওয়ায়েত ডাউনলোড' },
  ...
  { id: 'arabic', emoji: '🔤', titleKey: 'resources_cat_arabic', items: [
    ...
    { name: 'Calligraphy Qalam', url: 'https://calligraphyqalam.com', emoji: '✒️',
      en: 'Learn Arabic calligraphy styles, tools & process', bn: 'আরবি ক্যালিগ্রাফির শৈলী, সরঞ্জাম ও পদ্ধতি শিখুন' },
  ...
  { id: 'seerah', emoji: '🌙', titleKey: 'resources_cat_seerah', items: [
    ...
    { name: 'Madain Project', url: 'https://madainproject.com', emoji: '🏛️',
      en: 'Abrahamic history & archaeology of seerah sites', bn: 'সীরাহর স্থানসমূহের ইতিহাস ও প্রত্নতত্ত্ব বিশ্বকোষ' },
  ] },
  ...
  { id: 'hadith', emoji: '📜', titleKey: 'resources_cat_hadith', items: [
    ...
    { name: 'HadeethEnc', url: 'https://hadeethenc.com/en/home', emoji: '📚',
      en: 'Explained hadith encyclopedia in 70 languages', bn: '৭০ ভাষায় ব্যাখ্যাসহ অনূদিত হাদিস বিশ্বকোষ' },
    { name: 'Dorar Encyclopedias', url: 'https://dorar.net/en', emoji: '📜',
      en: 'Hadith grading & scholarly Islamic encyclopedias', bn: 'হাদিসের বিশুদ্ধতা যাচাই ও ইসলামি জ্ঞানকোষ' },
  ] },
  ...
  { id: 'courses', emoji: '🎓', titleKey: 'resources_cat_courses', items: [
    ...
    { name: 'New Muslim Guide', url: 'https://www.newmuslimguide.com/en', emoji: '🧭',
      en: 'Illustrated worship basics guide in 26 languages', bn: '২৬ ভাষায় সচিত্র ইবাদতের মৌলিক গাইড' },
    { name: 'International Open University', url: 'https://iou.edu.gm', emoji: '🎓',
      en: 'Free Islamic studies diploma & certificate courses', bn: 'ফ্রি ইসলামিক স্টাডিজ ডিপ্লোমা ও সার্টিফিকেট কোর্স' },
  ] },
  { id: 'academic', emoji: '📜', titleKey: 'resources_cat_academic', items: [
    ...
    { name: 'Ghazali.org', url: 'https://www.ghazali.org', emoji: '🕯️',
      en: 'Complete al-Ghazali digital library & translations', bn: 'ইমাম গাযালির পূর্ণাঙ্গ ডিজিটাল লাইব্রেরি ও অনুবাদ' },
    { name: 'Renovatio (Zaytuna)', url: 'https://renovatio.zaytuna.edu', emoji: '🖋️',
      en: 'Zaytuna College free journal of Islamic thought', bn: 'ইসলামি চিন্তাধারায় যায়তুনা কলেজের ফ্রি জার্নাল' },
