...
const QA_GLOSSARY = [
  ...
  { ar: 'صَرْف', translit: 'ṣarf', en: 'Morphology — the science of how words are built and cast into patterns.', bn: 'সরফ — শব্দ কীভাবে গঠিত ও ছাঁচে ঢালা হয় তার বিদ্যা।' },
  { ar: 'نَحْو', translit: 'naḥw', en: 'Syntax — the science of how words join and take their endings.', bn: 'নাহু — শব্দ কীভাবে যুক্ত হয় ও শেষ (এ‘রাব) নেয় তার বিদ্যা।' },
  { ar: 'مُجَرَّد', translit: 'mujarrad', en: 'Bare verb (Form I) — root letters only, nothing added.', bn: 'মুজাররাদ — শুধু মূল অক্ষরের ক্রিয়া (প্রথম ছাঁচ), কিছুই যোগ নেই।', ex: { ar: 'خَلَقَ', ref: '96:1' } },
  { ar: 'مَزِيد', translit: 'mazīd', en: 'Augmented verb — one or more letters added to the bare root.', bn: 'মাযীদ — মূলের সাথে এক বা একাধিক অক্ষর যোগ করা ক্রিয়া।', ex: { ar: 'أَنزَلْنَٰهُ', ref: '97:1' } },
  { ar: 'تَفْعِيل', translit: 'tafʿīl', en: 'Form II (فَعَّلَ) — doubled middle letter; intensive or causative.', bn: 'দ্বিতীয় ছাঁচ (فَعَّلَ) — মধ্য অক্ষর দ্বিগুণ; তীব্রতা বা করানো বোঝায়।', ex: { ar: 'عَلَّمَ', ref: '96:4' } },
  { ar: 'إِفْعَال', translit: 'ifʿāl', en: 'Form IV (أَفْعَلَ) — a prefixed hamza that makes the verb causative.', bn: 'চতুর্থ ছাঁচ (أَفْعَلَ) — উপসর্গ হামযা ক্রিয়াকে "করানো" অর্থ দেয়।', ex: { ar: 'أَعْطَيْنَٰكَ', ref: '108:1' } },
  { ar: 'تَفَعُّل', translit: 'tafaʿʿul', en: 'Form V (تَفَعَّلَ) — Form II with تَ; the action turns back on the doer.', bn: 'পঞ্চম ছাঁচ (تَفَعَّلَ) — تَ সহ দ্বিতীয় ছাঁচ; কাজ কর্তার নিজের উপরে ফেরে।', ex: { ar: 'تَنَزَّلُ', ref: '97:4' } },
  { ar: 'اِفْتِعَال', translit: 'iftiʿāl', en: 'Form VIII (اِفْتَعَلَ) — an infixed تَ; often reflexive or middle in sense.', bn: 'অষ্টম ছাঁচ (اِفْتَعَلَ) — ভিতরে যুক্ত تَ; প্রায়ই আত্মমুখী অর্থ।', ex: { ar: 'ٱقْتَرَبَ', ref: '21:1' } },
  { ar: 'اِسْتِفْعَال', translit: 'istifʿāl', en: 'Form X (اِسْتَفْعَلَ) — to seek or ask for the meaning of the root.', bn: 'দশম ছাঁচ (اِسْتَفْعَلَ) — মূলের অর্থ চাওয়া বা কামনা করা।', ex: { ar: 'نَسْتَعِينُ', ref: '1:5' } },
  { ar: 'صِفَة مُشَبَّهَة', translit: 'ṣifah mushabbahah', en: 'Quasi-participle — an adjective of a settled, lasting quality.', bn: 'সিফাত মুশাব্বাহা — স্থায়ী ও অবিচল গুণবাচক বিশেষণ।', ex: { ar: 'ٱلْكَرِيمِ', ref: '82:6' } },
  { ar: 'اِسْم الْمَكَان', translit: 'ism al-makān', en: 'Noun of place (مَفْعَل) — where the action happens.', bn: 'স্থানবাচক বিশেষ্য (مَفْعَل) — যেখানে কাজটি ঘটে।', ex: { ar: 'ٱلْمَسْجِدِ', ref: '17:1' } },
  { ar: 'اِسْم الآلَة', translit: 'ism al-ālah', en: 'Noun of instrument (مِفْعَل، مِفْعَال) — the tool the action is done with.', bn: 'যন্ত্রবাচক বিশেষ্য (مِفْعَل، مِفْعَال) — যে হাতিয়ার দিয়ে কাজ হয়।', ex: { ar: 'ٱلْمِيزَانَ', ref: '55:7' } },
  { ar: 'فِعْل مُعْتَلّ', translit: 'fiʿl muʿtall', en: 'Weak verb — one of its root letters is و، ا or ي.', bn: 'দুর্বল ক্রিয়া — মূল অক্ষরের একটি و، ا বা ي।', ex: { ar: 'قَالَ', ref: '2:30' } },
  { ar: 'أَجْوَف', translit: 'ajwaf', en: 'Hollow verb — the weak letter is the middle root letter.', bn: 'আজওয়াফ — দুর্বল অক্ষরটি মূলের মধ্যবর্তী।', ex: { ar: 'يَكُن', ref: '112:4' } },
  { ar: 'نَاقِص', translit: 'nāqiṣ', en: 'Defective verb — the weak letter is the final root letter.', bn: 'নাকিস — দুর্বল অক্ষরটি মূলের শেষে।', ex: { ar: 'يَخْشَىٰ', ref: '87:10' } },
  { ar: 'مِثَال', translit: 'mithāl', en: 'Assimilated verb — the first root letter is و or ي.', bn: 'মিসাল — মূলের প্রথম অক্ষর و বা ي।', ex: { ar: 'وَوَجَدَكَ', ref: '93:7' } },
  { ar: 'مُضَاعَف', translit: 'muḍāʿaf', en: 'Doubled verb — the second and third root letters are the same.', bn: 'মুদা‘আফ — মূলের দ্বিতীয় ও তৃতীয় অক্ষর একই।', ex: { ar: 'مَدَّ', ref: '25:45' } },
  { ar: 'مُعْرَب', translit: 'muʿrab', en: 'Declinable — a word whose ending changes with its role in the sentence.', bn: 'মু‘রাব — যে শব্দের শেষ বাক্যে ভূমিকা অনুযায়ী বদলায়।', ex: { ar: 'نَصْرُ', ref: '110:1' } },
  { ar: 'مَبْنِيّ', translit: 'mabnī', en: 'Indeclinable — a word with one fixed ending, whatever its role.', bn: 'মাবনী — ভূমিকা যাই হোক, যার শেষ অপরিবর্তিত থাকে।', ex: { ar: 'هَٰذَا', ref: '106:3' } },
  { ar: 'نَائِب الْفَاعِل', translit: 'nāʾib al-fāʿil', en: 'Deputy subject — takes rafʿ in place of the doer in a passive sentence.', bn: 'নায়িবুল ফা‘িল — কর্মবাচ্য বাক্যে কর্তার স্থানে রফ‘ পায়।', ex: { ar: 'ٱلْإِنسَٰنُ', ref: '4:28' } },
  { ar: 'مَفْعُول مُطْلَق', translit: 'mafʿūl muṭlaq', en: 'Cognate accusative — a maṣdar of the same verb, added for emphasis.', bn: 'মাফ‘ূল মুতলাক — একই ক্রিয়ার মাসদার, জোর দিতে যুক্ত (নসব)।', ex: { ar: 'تَسْلِيمًا', ref: '33:56' } },
  { ar: 'مَفْعُول لِأَجْلِهِ', translit: 'mafʿūl li-ajlihi', en: 'Object of purpose (naṣb) — the reason for which the act is done.', bn: 'মাফ‘ূল লিআজলিহি (নসব) — যে কারণে কাজটি করা হয়।', ex: { ar: 'خَشْيَةَ', ref: '17:31' } },
  { ar: 'ظَرْف', translit: 'ẓarf', en: 'Adverbial noun (naṣb) of time or place — the "when" or "where".', bn: 'যরফ — সময় বা স্থানবাচক বিশেষ্য (নসব) — "কখন" বা "কোথায়"।', ex: { ar: 'يَوْمَ', ref: '101:4' } },
  { ar: 'مُنَادَى', translit: 'munādā', en: 'The one called — the noun addressed after يَا ("O…").', bn: 'মুনাদা — يَا ("হে…")-এর পরে সম্বোধিত বিশেষ্য।', ex: { ar: 'يَٰمَرْيَمُ', ref: '3:37' } },
  { ar: 'مُضَاف إِلَيْهِ', translit: 'muḍāf ilayhi', en: 'The possessor in an iḍāfah — always in jarr.', bn: 'ইদাফার মালিক-অংশ — সর্বদা জর অবস্থায়।', ex: { ar: 'ٱلنَّاسِ', ref: '114:1' } },
  { ar: 'نَعْت', translit: 'naʿt', en: 'Adjective — follows its noun in case, number, gender and definiteness.', bn: 'না‘ত (বিশেষণ) — এ‘রাব, বচন, লিঙ্গ ও নির্দিষ্টতায় বিশেষ্যের অনুগামী।', ex: { ar: 'ٱلرَّحِيمِ', ref: '1:1' } },
  { ar: 'بَدَل', translit: 'badal', en: 'Substitute — a noun restating the one before it in the same case.', bn: 'বদল — পূর্বের বিশেষ্যকে একই এ‘রাবে পুনরায় বোঝানো শব্দ।', ex: { ar: 'صِرَٰطَ', ref: '1:7' } },
  { ar: 'تَوْكِيد', translit: 'tawkīd', en: 'Emphasis — a word reinforcing what precedes it (كُلّ، أَجْمَع).', bn: 'তাওকীদ — পূর্বের শব্দকে জোরদার করা শব্দ (كُلّ، أَجْمَع)।', ex: { ar: 'أَجْمَعُونَ', ref: '15:30' } },
  { ar: 'عَطْف', translit: 'ʿaṭf', en: 'Coordination with وَ، فَ، ثُمَّ — the joined word copies the case of the first.', bn: 'আতফ — وَ، فَ، ثُمَّ দিয়ে যোগ; পরের শব্দ আগের এ‘রাব গ্রহণ করে।', ex: { ar: 'وَٱلْفَتْحُ', ref: '110:1' } },
  { ar: 'جَارّ وَمَجْرُور', translit: 'jārr wa majrūr', en: 'A preposition with its genitive noun, treated as one unit.', bn: 'জার ও মাজরূর — অব্যয় ও তার জর-প্রাপ্ত বিশেষ্য, একক একক হিসেবে গণ্য।', ex: { ar: 'لِلَّهِ', ref: '1:2' } },
  { ar: 'شِبْه الْجُمْلَة', translit: 'shibh al-jumlah', en: 'Quasi-sentence — a jārr-majrūr or ẓarf standing in for a predicate.', bn: 'শিবহুল জুমলা — জার-মাজরূর বা যরফ, যা বিধেয়ের স্থান নেয়।', ex: { ar: 'عَلَيْهِمْ', ref: '1:7' } },
  { ar: 'كَانَ وَأَخَوَاتُهَا', translit: 'kāna wa akhawātuhā', en: 'كَانَ and her sisters — keep the subject in rafʿ, put the predicate in naṣb.', bn: 'كَانَ ও তার বোনেরা — উদ্দেশ্যকে রফ‘ রাখে, বিধেয়কে নসব করে।', ex: { ar: 'كَانَ', ref: '2:213' } },
  { ar: 'حُرُوف النَّصْب', translit: 'ḥurūf an-naṣb', en: 'Subjunctive particles (أَنْ، لَنْ، كَيْ، إِذَنْ) — put the present verb in naṣb.', bn: 'নসবের অব্যয় (أَنْ، لَنْ، كَيْ، إِذَنْ) — বর্তমান ক্রিয়াকে নসব করে।', ex: { ar: 'لَن', ref: '2:80' } },
  { ar: 'حُرُوف الْجَزْم', translit: 'ḥurūf al-jazm', en: 'Jussive particles (لَمْ، لَمَّا، prohibitive لَا، لِـ of command) — put the present verb in jazm.', bn: 'জযমের অব্যয় (لَمْ، لَمَّا، নিষেধের لَا، আদেশের لِـ) — বর্তমান ক্রিয়াকে জযম দেয়।', ex: { ar: 'لَمْ', ref: '112:3' } },
  { ar: 'اِسْم مَوْصُول', translit: 'ism mawṣūl', en: 'Relative pronoun (ٱلَّذِي، ٱلَّتِي، مَنْ، مَا) introducing a describing clause.', bn: 'সম্বন্ধবাচক সর্বনাম (ٱلَّذِي، ٱلَّتِي، مَنْ، مَا), যা বর্ণনামূলক বাক্যাংশ আনে।', ex: { ar: 'ٱلَّذِينَ', ref: '1:7' } },
  { ar: 'اِسْم إِشَارَة', translit: 'ism ishārah', en: 'Demonstrative (هَٰذَا، ذَٰلِكَ) — points to something near or far.', bn: 'নির্দেশক সর্বনাম (هَٰذَا، ذَٰلِكَ) — নিকট বা দূরের বস্তুকে দেখায়।', ex: { ar: 'ذَٰلِكَ', ref: '2:2' } },
  { ar: 'اِسْم اِسْتِفْهَام', translit: 'ism istifhām', en: 'Interrogative word (مَنْ، مَا، كَيْفَ، أَيْنَ) — used to ask a question.', bn: 'প্রশ্নবাচক শব্দ (مَنْ، مَا، كَيْفَ، أَيْنَ) — প্রশ্ন করতে ব্যবহৃত।', ex: { ar: 'كَيْفَ', ref: '105:1' } },
  { ar: 'جَوَاب الشَّرْط', translit: 'jawāb ash-sharṭ', en: 'The answer of a condition — the "then…" clause that follows the "if…".', bn: 'জাওয়াবুশ শর্ত — শর্তের উত্তর-অংশ, "তবে…"।', ex: { ar: 'يَرَهُۥ', ref: '99:7' } },
  { ar: 'نَكِرَة', translit: 'nakirah', en: 'Indefinite noun — "a / an", usually marked by tanwīn.', bn: 'নাকিরা — অনির্দিষ্ট বিশেষ্য, সাধারণত তানভীন দিয়ে চিহ্নিত।', ex: { ar: 'هُدًى', ref: '2:2' } },
  { ar: 'مُثَنَّى', translit: 'muthannā', en: 'Dual — exactly two, ending ‑āni in rafʿ and ‑ayni in naṣb/jarr.', bn: 'মুসান্না — ঠিক দুটি; রফ‘-এ ‑āni, নসব/জর-এ ‑ayni।', ex: { ar: 'جَنَّتَانِ', ref: '55:46' } },
  { ar: 'جَمْع مُذَكَّر سَالِم', translit: 'jamʿ mudhakkar sālim', en: 'Sound masculine plural — ‑ūna in rafʿ, ‑īna in naṣb and jarr.', bn: 'সহিহ পুংলিঙ্গ বহুবচন — রফ‘-এ ‑ūna, নসব ও জর-এ ‑īna।', ex: { ar: 'ٱلْمُفْلِحُونَ', ref: '2:5' } },
  { ar: 'جَمْع مُؤَنَّث سَالِم', translit: 'jamʿ muʾannath sālim', en: 'Sound feminine plural — ‑āt; its naṣb is shown with kasrah, not fatḥah.', bn: 'সহিহ স্ত্রীলিঙ্গ বহুবচন — ‑āt; এর নসব ফাতহা নয়, কাসরা দিয়ে দেখানো হয়।', ex: { ar: 'ٱلصَّٰلِحَٰتِ', ref: '103:3' } },
  { ar: 'مَمْنُوع مِنَ الصَّرْف', translit: 'mamnūʿ min aṣ-ṣarf', en: 'Diptote — a noun that refuses tanwīn; its jarr is shown with fatḥah.', bn: 'মামনূ‘ মিনাস সরফ — যে বিশেষ্য তানভীন নেয় না; তার জর ফাতহা দিয়ে হয়।', ex: { ar: 'إِبْرَٰهِيمَ', ref: '87:19' } },
];
...
const QA_IRAB = [
  ...
  { ref: '2:163', q: QA_IRAB_Q,
    ...
    options: [{ en: 'ḥarf (negation of genus, naṣb)', bn: 'হারফ (শ্রেণি-নিষেধ, নসব)' }, { en: 'fāʿil (doer)', bn: 'ফা‘িল (কর্তা)' }, { en: 'mubtadaʾ (subject)', bn: 'মুবতাদা (উদ্দেশ্য)' }, { en: 'ḥāl (state)', bn: 'হাল (অবস্থা)' }], answer: 0,
    explain: { en: 'لَّآ is the negation of genus (lā al-nāfiya li-l-jins), which puts إِلَٰهَ into naṣb: "there is no god".', bn: 'لَّآ হলো লা নাফিয়া লিল-জিনস — সমগ্র শ্রেণির নিষেধ, যা إِلَٰهَ-কে নসব দেয়: "কোনো ইলাহ নেই"।' } },
  { ref: '2:285', q: QA_IRAB_Q,
    words: [ { ar: 'ءَامَنَ' }, { ar: 'ٱلرَّسُولُ', hl: true }, { ar: 'بِمَآ' }, { ar: 'أُنزِلَ' }, { ar: 'إِلَيْهِ' }, { ar: 'مِن رَّبِّهِۦ' } ],
    options: [{ en: 'fāʿil (doer of a past verb)', bn: 'ফা‘িল (অতীত ক্রিয়ার কর্তা)' }, { en: 'mafʿūl bihi (object)', bn: 'মাফ‘ূল বিহি (কর্ম)' }, { en: 'khabar (predicate)', bn: 'খবর (বিধেয়)' }, { en: 'muḍāf ilayh', bn: 'মুযাফ ইলাইহি' }], answer: 0,
    explain: { en: 'ٱلرَّسُولُ ends in ‑u (rafʿ) and is the doer (fāʿil) of the past verb ءَامَنَ.', bn: 'ٱلرَّسُولُ ‑u (রফ‘)-এ শেষ, আর এটি অতীত ক্রিয়া ءَامَنَ-এর ফা‘িল (কর্তা)।' } },
  { ref: '36:82', q: QA_IRAB_Q,
    ...
    options: [{ en: 'command verb (amr)', bn: 'আদেশসূচক ক্রিয়া (ফি‘ল আমর)' }, { en: 'present verb (muḍāriʿ)', bn: 'বর্তমান ক্রিয়া (মুদারি‘)' }, { en: 'past verb (māḍī)', bn: 'অতীত ক্রিয়া (মাদী)' }, { en: 'verbal noun (maṣdar)', bn: 'ক্রিয়াবাচক বিশেষ্য (মাসদার)' }], answer: 0,
    explain: { en: 'كُن is a command (amr): "Be!" — it is the essence of creation by divine will.', bn: 'كُن একটি আদেশসূচক ক্রিয়া (ফি‘ল আমর): "হও!" — এটিই আল্লাহর ইচ্ছায় সৃষ্টির সারকথা।' } },
  { ref: '1:5', q: QA_IRAB_Q,
    words: [ { ar: 'إِيَّاكَ', hl: true }, { ar: 'نَعْبُدُ' }, { ar: 'وَإِيَّاكَ' }, { ar: 'نَسْتَعِينُ' } ],
    options: [{ en: 'mafʿūl bihi (object) placed before the verb', bn: 'মাফ‘ূল বিহি (কর্ম) যা ক্রিয়ার আগে এসেছে' }, { en: 'mubtadaʾ (subject)', bn: 'মুবতাদা (উদ্দেশ্য)' }, { en: 'fāʿil (doer)', bn: 'ফা‘িল (কর্তা)' }, { en: 'ḥarf (particle)', bn: 'হারফ (অব্যয়)' }], answer: 0,
    explain: { en: 'إِيَّاكَ is the object of نَعْبُدُ placed before the verb for emphasis — "You alone we worship."', bn: 'إِيَّاكَ হলো نَعْبُدُ-এর মাফ‘ূল, যা জোর দেওয়ার জন্য ক্রিয়ার আগে এসেছে — "কেবল আপনারই আমরা ইবাদত করি"।' } },
  { ref: '2:177', q: QA_IRAB_Q,
    words: [ { ar: 'لَّٰكِنَّ', hl: true }, { ar: 'ٱلْبِرَّ' }, { ar: 'مَنْ' }, { ar: 'ءَامَنَ' }, { ar: 'بِٱللَّهِ' } ],
    options: [{ en: 'ḥarf nasb (sister of إِنَّ, nasb)', bn: 'হারফ নসব (إِنَّ-এর বোন, নসব)' }, { en: 'harf jarr (preposition)', bn: 'হারফ জার (অব্যয়)' }, { en: 'istithnāʾ (exception)', bn: 'ইসতিসনা (ব্যতিক্রম)' }, { en: 'ʿaṭf (connector)', bn: '‘আতফ (সংযোজক)' }], answer: 0,
    explain: { en: 'لَّٰكِنَّ is a sister of إِنَّ (ḥarf nasb wa tawkīd), putting its subject ٱلْبِرَّ in naṣb.', bn: 'لَّٰكِنَّ হলো إِنَّ-এর বোন (হারফ নসব ও তাকীদ), যা তার ইসম ٱلْبِرَّ-কে নসব দেয়।' } },
  { ref: '30:30', q: QA_IRAB_Q,
    words: [ { ar: 'فَأَقِمْ' }, { ar: 'وَجْهَكَ' }, { ar: 'لِلدِّينِ' }, { ar: 'حَنِيفًا', hl: true } ],
    options: [{ en: 'ḥāl (state/manner)', bn: 'হাল (অবস্থা/ধরন)' }, { en: 'mafʿūl bihi (object)', bn: 'মাফ‘ূল বিহি (কর্ম)' }, { en: 'tamyīz (specification)', bn: 'তাময়ীয (নির্দিষ্টকরণ)' }, { en: 'khabar (predicate)', bn: 'খবর (বিধেয়)' }], answer: 0,
  ...
  { ref: '9:40', q: QA_IRAB_Q,
    ...
    options: [{ en: 'ḥarf jazm (negates a present verb, jazm)', bn: 'হারফ জাযম (মুদারি‘কে জাযম দেয়)' }, { en: 'ḥarf nasb (makes naṣb)', bn: 'হারফ নসব (নসব দেয়)' }, { en: 'istifhām (question)', bn: 'ইসতিফহাম (প্রশ্ন)' }, { en: 'qasam (oath)', bn: 'কসম (শপথ)' }], answer: 0,
    explain: { en: 'لَّمْ is a negation particle that puts the present verb تَرَوْ into the jussive (jazm) — "you did not see".', bn: 'لَّمْ নিষেধসূচক হারফ, যা মুদারি‘ ক্রিয়া تَرَوْ-কে জাযম দেয় — "তোমরা কি দেখোনি"।' } },
  { ref: '55:26', q: QA_IRAB_Q,
    words: [ { ar: 'كُلُّ' }, { ar: 'مَنْ' }, { ar: 'عَلَيْهَا' }, { ar: 'فَانٍ', hl: true } ],
    options: [{ en: 'khabar (predicate of nominal sentence, rafʿ)', bn: 'খবর (নামবাচক বাক্যের বিধেয়, রফ‘)' }, { en: 'mubtadaʾ (subject)', bn: 'মুবতাদা (উদ্দেশ্য)' }, { en: 'fāʿil (doer)', bn: 'ফা‘িল (কর্তা)' }, { en: 'mafʿūl (object)', bn: 'মাফ‘ূল (কর্ম)' }], answer: 0,
    explain: { en: 'كُلُّ is the mubtadaʾ; فَانٍ is its khabar (predicate) in rafʿ: "everything (on it) is perishing."', bn: 'كُلُّ হলো মুবতাদা, আর فَانٍ তার খবর রফ‘-এ: "এর উপর যা কিছু আছে সবই ধ্বংসশীল"।' } },
  { ref: '5:6', q: QA_IRAB_Q,
    ...
    options: [{ en: 'mafʿūl bihi (object, naṣb) joined by wa', bn: 'মাফ‘ূল বিহি (কর্ম, নসব) ওয়াও দিয়ে যুক্ত' }, { en: 'fāʿil (doer, rafʿ)', bn: 'ফা‘িল (কর্তা, রফ‘)' }, { en: 'muḍāf ilayh (jarr)', bn: 'মুযাফ ইলাইহি (জার)' }, { en: 'ḥāl (state, naṣb)', bn: 'হাল (অবস্থা, নসব)' }], answer: 0,
    explain: { en: 'وَأَرْجُلَكُمْ is joined by the conjunction وَ to the object وُجُوهَكُمْ — both are objects of the command wash/wipe (mafʿūl bihi, naṣb).', bn: 'وَأَرْجُلَكُمْ সংযোজক وَ দিয়ে মাফ‘ূল وُجُوهَكُمْ-এর সঙ্গে যুক্ত — উভয়ই ধোয়া/মাসেহ করার আদেশের মাফ‘ূল বিহি (নসব)।' } },
