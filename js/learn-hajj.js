  ...
  render() {
    ...
    this.root.innerHTML = `
      <div class="w-full space-y-6 py-4">
        ...
        <div class="rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-5">
          ...
          <div class="space-y-3">
            ...
            <div class="p-3 rounded-xl bg-gray-50 dark:bg-gray-900/40">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-1" dir="auto">${L({ en: 'After sunrise, proceed to Arafah. Stand in prayer and supplication (Wuquf) until sunset — this is the supreme pillar of Hajj ("Hajj is Arafah"). After sunset, leave Arafah WITHOUT praying Maghrib there and travel to Muzdalifah; pray Maghrib and Isha combined on arrival, and stay the night (mabit at Muzdalifah — a wajib; leaving early without excuse requires a dam).', bn: 'সূর্যোদয়ের পর আরাফার দিকে রওনা হন। সূর্যাস্ত পর্যন্ত দোয়া ও ইবাদতে অবস্থান করুন (উকুফ) — এটাই হজের সর্বোচ্চ রুকন ("হজই আরাফা")। সূর্যাস্তের পর আরাফায় মাগরিব না পড়েই মুজদালিফার দিকে রওনা হন; পৌঁছে মাগরিব ও ইশা একত্রে পড়ুন এবং রাত সেখানেই কাটান (মুজদালিফায় মাবীত — ওয়াজিব; ওজর ছাড়া আগে চলে গেলে দম ওয়াজিব হয়)।' })}</p>
            </div>
            <div class="p-3 rounded-xl bg-gray-50 dark:bg-gray-900/40">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-1" dir="auto">${L({ en: 'Pray Fajr at Muzdalifah, make du\'a until it is nearly light, then proceed to Mina (pebbles may be gathered at Muzdalifah or in Mina). Stone Jamarat al-Aqabah only (7 pebbles). Sacrifice an animal (Hady/Qurbani). Shave or trim the hair (Halaq/Taqsir). Then perform Tawaf al-Ifadah and, for those who have not yet done it, Sa\'i — this is the day of Tawaf al-Ifadah.', bn: 'মুজদালিফায় ফজর পড়ুন, ফর্সা হওয়ার আগ পর্যন্ত দোয়া করুন, তারপর মিনায় যান (পাথর মুজদালিফা বা মিনা — যেকোনো স্থান থেকে সংগ্রহ করা যায়)। শুধু জামারায়ে আকাবায় ৭টি পাথর নিক্ষেপ করুন। পশু কুরবানি করুন (হাদি/কুরবানি)। মাথা মুণ্ডন বা চুল ছাঁটুন (হালাক/তাকসির)। এরপর তাওয়াফে ইফাদা করুন এবং যাদের সাঈ বাকি আছে তারা সাঈ করুন — এই দিনটিই তাওয়াফে ইফাদার দিন।' })}</p>
            </div>
            <div class="p-3 rounded-xl bg-gray-50 dark:bg-gray-900/40">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-1" dir="auto">${L({ en: 'Spend the nights in Mina (mabit — a wajib). Each day after Dhuhr, stone all three Jamarat in order (small, middle, large — 7 pebbles each). One may leave after the 12th (nafr awwal) before sunset, or stay for the 13th. If Tawaf al-Ifadah was not done on the 10th, it must still be completed in these days. On leaving Makkah, perform the farewell Tawaf (Tawaf al-Wida) as the last act.', bn: 'রাতগুলো মিনায় কাটান (মাবীত — ওয়াজিব)। প্রতিদিন যোহরের পর ক্রমানুসারে তিনটি জামারায় (ছোট, মধ্যম, বড় — প্রতিটিতে ৭টি) পাথর নিক্ষেপ করুন। ইচ্ছা করলে ১২ তারিখ সূর্যাস্তের আগে চলে যাওয়া যায় (নফরে আউয়াল), অথবা ১৩ তারিখ পর্যন্ত থাকা যায়। ১০ তারিখে তাওয়াফে ইফাদা না করে থাকলে এ দিনগুলোতেই তা সম্পন্ন করতে হবে। মক্কা ত্যাগ করার সময় সর্বশেষ কাজ হিসেবে বিদায়ী তাওয়াফ (তাওয়াফুল বিদা) করুন।' })}</p>
            </div>
          </div>
        </div>
        ...
        <div class="rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-5">
          ...
          <div class="space-y-2">
            ${[
              ...
              { q: { en: 'What does the Talbiyah actually mean, phrase by phrase?', bn: 'তালবিয়ার প্রকৃত অর্থ কী — বাক্যাংশ ধরে ধরে?' }, a: { en: '"Labbayk Allahumma labbayk" — "Here I am, O Allah, here I am" — is the servant\'s answer to Ibrahim\'s ancient proclamation of Hajj (22:27). "Labbayk" implies remaining in continual obedience, answering call after call. "La sharika lak" renounces every form of shirk, and "innal-hamda wan-ni\'mata laka wal-mulk" affirms that all praise, favour and sovereignty belong to Allah alone. It is the pilgrim\'s open declaration of pure tawhid, recited from entering ihram until stoning Jamarat al-Aqabah on the 10th. (Sahih Muslim 1184)', bn: '"লাব্বাইক আল্লাহুম্মা লাব্বাইক" — "আমি হাজির, হে আল্লাহ, আমি হাজির" — ইবরাহীম (আঃ)-এর হজের প্রাচীন ঘোষণার (২২:২৭) জবাব। "লাব্বাইক" অর্থ বারবার ডাকে সাড়া দিয়ে নিরবচ্ছিন্ন আনুগত্যে থাকা। "লা শারিকা লাক" সব ধরনের শিরক প্রত্যাখ্যান করে, আর "ইন্নাল হামদা ওয়ান-নি\'মাতা লাকা ওয়াল-মুলক" ঘোষণা করে সমস্ত প্রশংসা, নিয়ামত ও রাজত্ব একমাত্র আল্লাহর। এটি খাঁটি তাওহীদের প্রকাশ্য ঘোষণা — ইহরাম বাঁধা থেকে ১০ তারিখে জামারায়ে আকাবায় পাথর নিক্ষেপ পর্যন্ত পড়া হয়। (সহীহ মুসলিম ১১৮৪)' } },
              { q: { en: 'What are the rulings of the Days of Tashriq (11th-13th Dhul-Hijjah)?', bn: 'আইয়ামে তাশরিকের (১১-১৩ জিলহজ) বিধানগুলো কী?' }, a: { en: 'They are "days of eating, drinking and remembrance of Allah" (Sahih Muslim 1141) — fasting them is forbidden, except for the Tamattu\'/Qiran pilgrim who cannot afford the hady (Sahih al-Bukhari 1997-1998). Pilgrims spend the nights in Mina and stone the three Jamarat each day after zawal (midday), saying takbir with every pebble; takbir after the obligatory prayers also continues through these days. Quran 2:203 permits departing Mina on the 12th before sunset (nafr awwal) with no sin — "whoever hastens in two days, there is no sin upon him" — though staying until the 13th is better.', bn: 'এগুলো "পানাহার ও আল্লাহর যিকিরের দিন" (সহীহ মুসলিম ১১৪১) — এই দিনগুলোতে রোজা নিষিদ্ধ, তবে হাদি দিতে অক্ষম তামাত্তু/কিরান হাজির জন্য ব্যতিক্রম (সহীহ বুখারী ১৯৯৭-১৯৯৮)। হাজিরা মিনায় রাত কাটান এবং প্রতিদিন যাওয়ালের (দুপুরের) পর তিন জামারায় পাথর মারেন, প্রতিটি পাথরে তাকবীর বলেন; এই দিনগুলোতে ফরজ নামাজের পর তাকবীরও চলতে থাকে। কুরআন ২:২০৩ অনুযায়ী ১২ তারিখ সূর্যাস্তের আগে মিনা ত্যাগ (নফরে আউয়াল) করলে গুনাহ নেই — "যে দুই দিনে তাড়াতাড়ি করে তার কোনো পাপ নেই" — তবে ১৩ পর্যন্ত থাকা উত্তম।' } },
              { q: { en: 'What is the sunnah regarding Zamzam water?', bn: 'জমজমের পানি সম্পর্কে সুন্নাত কী?' }, a: { en: 'Drinking Zamzam after Tawaf is sunnah — the Prophet ﷺ drank it and said: "It is blessed; it is food that satisfies." (Sahih Muslim 2473). He also said: "The water of Zamzam is for whatever it is drunk for." (Sunan Ibn Majah 3062 — hasan), so drink it with du\'a and a good intention. Carrying it home is also established — Aishah (RA) reported that the Prophet ﷺ used to carry Zamzam. (Tirmidhi 963 — hasan)', bn: 'তাওয়াফের পর জমজম পান করা সুন্নাত — নবী ﷺ তা পান করেছেন এবং বলেছেন: "এটি বরকতময়; এটি তৃপ্তিদায়ক খাদ্য।" (সহীহ মুসলিম ২৪৭৩)। তিনি আরও বলেছেন: "জমজমের পানি যে উদ্দেশ্যে পান করা হয় তার জন্যই।" (সুনানে ইবনে মাজাহ ৩০৬২ — হাসান), তাই দোয়া ও নেক নিয়তে পান করুন। সাথে করে নিয়ে যাওয়াও প্রমাণিত — আয়িশা (রাঃ) বর্ণনা করেন নবী ﷺ জমজম বহন করতেন। (তিরমিযী ৯৬৩ — হাসান)' } },
              { q: { en: 'Is a child\'s Hajj valid, and does it discharge the obligatory Hajj?', bn: 'শিশুর হজ কি সহীহ, এবং তাতে কি ফরজ হজ আদায় হয়?' }, a: { en: 'A woman lifted up a child and asked: "Is there Hajj for this one?" The Prophet ﷺ said: "Yes, and you will have a reward." (Sahih Muslim 1336). So a child\'s Hajj is valid and rewarded — the guardian makes the intention for a small child and carries them in tawaf. However, by scholarly consensus it does not discharge the obligatory Hajj: once the child reaches puberty and possesses the means, the fard Hajj must still be performed.', bn: 'এক মহিলা একটি শিশুকে তুলে ধরে জিজ্ঞেস করলেন: "এর কি হজ আছে?" নবী ﷺ বললেন: "হ্যাঁ, এবং তোমার জন্য সওয়াব রয়েছে।" (সহীহ মুসলিম ১৩৩৬)। সুতরাং শিশুর হজ সহীহ ও সওয়াবযোগ্য — ছোট শিশুর পক্ষে অভিভাবক নিয়ত করেন এবং কোলে নিয়ে তাওয়াফ করান। তবে আলিমদের ইজমা অনুযায়ী এতে ফরজ হজ আদায় হয় না: বালেগ ও সামর্থ্যবান হলে ফরজ হজ করতেই হবে।' } },
              { q: { en: 'From where do people living inside the Miqat — or in Makkah itself — enter ihram?', bn: 'মীকাতের ভেতরে বা খোদ মক্কায় বসবাসকারীরা কোথা থেকে ইহরাম বাঁধবেন?' }, a: { en: 'The Prophet ﷺ said: "Whoever is nearer than that (the miqats), his ihram is from where he starts; and the people of Makkah from Makkah." (Sahih al-Bukhari 1524). So residents inside the miqat enter ihram from their homes. For Hajj, Makkah residents also begin from Makkah; but for Umrah they must first go out to the nearest point of the Hill (outside the Haram boundary) — as the Prophet ﷺ sent Aishah (RA) with her brother to at-Tan\'im. (Sahih al-Bukhari 1784)', bn: 'নবী ﷺ বলেছেন: "যে এর (মীকাতসমূহের) চেয়ে কাছে, সে যেখান থেকে যাত্রা করবে সেখান থেকেই ইহরাম; আর মক্কাবাসীরা মক্কা থেকে।" (সহীহ বুখারী ১৫২৪)। সুতরাং মীকাতের ভেতরের বাসিন্দারা বাড়ি থেকে ইহরাম বাঁধবেন। হজের জন্য মক্কাবাসীও মক্কা থেকেই শুরু করবেন; তবে উমরার জন্য হারাম সীমানার বাইরে নিকটতম হিল এলাকায় যেতে হবে — যেমন নবী ﷺ আয়িশা (রাঃ)-কে তাঁর ভাইয়ের সাথে তানঈমে পাঠিয়েছিলেন। (সহীহ বুখারী ১৭৮৪)' } },
              { q: { en: 'What is the purpose and wisdom behind stoning the Jamarat?', bn: 'জামারায় পাথর নিক্ষেপের উদ্দেশ্য ও হিকমত কী?' }, a: { en: 'The rite commemorates Ibrahim (AS) pelting Shaytan when he tried to divert him from Allah\'s command at these very spots (Mustadrak al-Hakim — graded sahih). Its deeper purpose is remembrance: the Prophet ﷺ said, "Tawaf around the House, (Sa\'i) between Safa and Marwah, and the stoning of the Jamarat have only been established for the remembrance of Allah." (Tirmidhi 902, Abu Dawud 1888). It is an act of submission and rejection of Shaytan — not literally striking the devil — so the pebbles are small (chickpea-sized), and pushing or harming others contradicts the very spirit of the rite.', bn: 'এই আচার স্মরণ করায় ইবরাহীম (আঃ)-কে — আল্লাহর আদেশ থেকে বিচ্যুত করতে চাইলে ঠিক এই স্থানগুলোতে তিনি শয়তানকে পাথর মেরেছিলেন (মুসতাদরাকে হাকিম — সহীহ হিসেবে গৃহীত)। গভীর উদ্দেশ্য যিকির: নবী ﷺ বলেছেন, "বায়তুল্লাহর তাওয়াফ, সাফা-মারওয়ার সাঈ ও জামারায় পাথর নিক্ষেপ কেবল আল্লাহর স্মরণ প্রতিষ্ঠার জন্যই বিধিবদ্ধ হয়েছে।" (তিরমিযী ৯০২, আবু দাউদ ১৮৮৮)। এটি আনুগত্য ও শয়তান প্রত্যাখ্যানের আমল — আক্ষরিকভাবে শয়তানকে আঘাত নয় — তাই পাথর ছোট (ছোলার আকারের) এবং ধাক্কাধাক্কি বা অন্যকে কষ্ট দেওয়া এই আচারের চেতনার পরিপন্থী।' } },
            ].map(item => `
        ...
        <div class="rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-5">
          <h3 class="font-bold text-gray-800 dark:text-gray-100 mb-3 flex items-center gap-2">📕 ${L({ en: 'Hajj & Umrah Glossary — Key Terms', bn: 'হজ ও উমরার পরিভাষা — মূল শব্দাবলি' })}</h3>
          <p class="text-xs text-gray-500 dark:text-gray-400 mb-3" dir="auto">${L({ en: '12 essential terms every pilgrim should know.', bn: 'প্রত্যেক হাজির জানা উচিত ১২টি অপরিহার্য পরিভাষা।' })}</p>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ${[
              { term: { en: 'Miqat', bn: 'মীকাত' }, ar: 'الميقات', def: { en: 'The designated boundary points around Makkah at which a pilgrim must enter Ihram. Crossing them without Ihram (when intending Hajj/Umrah) requires returning or offering a dam.', bn: 'মক্কার চারপাশের নির্ধারিত সীমানা যেখানে হাজিকে ইহরাম বাঁধতে হয়। হজ/উমরার নিয়তে ইহরাম ছাড়া অতিক্রম করলে ফিরে আসতে হবে বা দম দিতে হবে।' } },
              { term: { en: 'Wuquf', bn: 'উকুফ' }, ar: 'الوقوف', def: { en: 'Standing at Arafah on the 9th of Dhul-Hijjah — the supreme pillar of Hajj. The Prophet ﷺ said: "Hajj is Arafah." (Tirmidhi) Its window runs from noon on the 9th to the dawn of the 10th.', bn: '৯ জিলহজ আরাফায় অবস্থান — হজের সর্বোচ্চ রুকন। নবী ﷺ বলেছেন: "হজই আরাফা।" (তিরমিযি) সময়সীমা ৯ তারিখ দুপুর থেকে ১০ তারিখ ভোর।' } },
              { term: { en: 'Tahallul', bn: 'তাহাল্লুল' }, ar: 'التحلل', def: { en: 'Exiting the state of Ihram. First tahallul (partial) comes after any two of: stoning Jamarat al-Aqabah, shaving/trimming, and Tawaf al-Ifadah — most Ihram restrictions lift except intimacy. Second tahallul (complete) lifts everything.', bn: 'ইহরাম থেকে মুক্ত হওয়া। প্রথম তাহাল্লুল (আংশিক) জামারায়ে আকাবায় পাথর, হালাক/তাকসির ও তাওয়াফে ইফাদা — এর যেকোনো দুটির পর হয়; সহবাস ছাড়া বেশিরভাগ নিষেধ ওঠে। দ্বিতীয় তাহাল্লুল (পূর্ণ) সবকিছু হালাল করে।' } },
              { term: { en: 'Hady', bn: 'হাদি' }, ar: 'الهدي', def: { en: 'The sacrificial animal (sheep, goat, or a share of a cow/camel) offered on the 10th–13th by pilgrims performing Tamattu\' or Qiran, in gratitude for combining Umrah and Hajj (2:196).', bn: 'তামাত্তু বা কিরান হাজি কর্তৃক ১০–১৩ তারিখে জবাই করা কুরবানির পশু (ছাগল, ভেড়া বা গরু/উটের অংশ) — উমরা ও হজ একত্রিত করার শুকরিয়ায় (২:১৯৬)।' } },
              { term: { en: 'Dam', bn: 'দম' }, ar: 'الدم', def: { en: 'A sacrificial expiation required for omitting a wajib (obligatory act) such as leaving Muzdalifah early or skipping the farewell Tawaf. Meat is distributed to the poor of the Haram.', bn: 'ওয়াজিব ছেড়ে দেওয়ার কাফফারা হিসেবে জবাই — যেমন মুজদালিফা তাড়াতাড়ি ছাড়া বা বিদায়ী তাওয়াফ বাদ। মাংস হারামের গরিবদের মধ্যে বিতরণ করা হয়।' } },
              { term: { en: 'Ihsar', bn: 'ইহসার' }, ar: 'الإحصار', def: { en: 'Being prevented from completing Hajj or Umrah after entering Ihram (by illness, an enemy, or blocked routes). The pilgrim offers a sacrifice where held and exits Ihram — as the Prophet ﷺ did at Hudaybiyah (2:196).', bn: 'ইহরাম বাঁধার পর হজ/উমরা সম্পন্ন করতে বাধাপ্রাপ্ত হওয়া (অসুস্থতা, শত্রু বা পথ বন্ধ)। হাজি সেখানেই কুরবানি করে ইহরাম খোলেন — নবী ﷺ হুদাইবিয়ায় এটাই করেছিলেন (২:১৯৬)।' } },
              { term: { en: 'Hajar al-Aswad', bn: 'হাজরে আসওয়াদ' }, ar: 'الحجر الأسود', def: { en: 'The Black Stone set in the eastern corner of the Kaaba, marking the start and end of each Tawaf circuit. Kiss it if possible; otherwise touch it, or point to it saying "Allahu Akbar" — no crowding or harming others.', bn: 'কাবার পূর্ব কোণে স্থাপিত কালো পাথর, প্রতিটি তাওয়াফ চক্রের শুরু ও শেষের চিহ্ন। সম্ভব হলে চুম্বন করুন; নয়তো ছোঁয়া বা "আল্লাহু আকবার" বলে ইশারা করুন — ভিড় বা কষ্ট না দিয়ে।' } },
              { term: { en: 'Rukn al-Yamani', bn: 'রুকনে ইয়ামানি' }, ar: 'الركن اليماني', def: { en: 'The Yemeni corner of the Kaaba, reached just before the Black Stone. It is only touched with the right hand if easy — it is not kissed and not pointed to. No du\'a is fixed for it except between it and the Black Stone (2:201).', bn: 'কাবার ইয়েমেনি কোণ, হাজরে আসওয়াদের ঠিক আগে। সহজ হলে শুধু ডান হাতে স্পর্শ করা হয় — চুম্বন বা ইশারা নয়। এর ও হাজরে আসওয়াদের মাঝ ছাড়া নির্দিষ্ট দোয়া নেই (২:২০১)।' } },
              { term: { en: 'Maqam Ibrahim', bn: 'মাকামে ইবরাহীম' }, ar: 'مقام إبراهيم', def: { en: 'The station of Ibrahim (AS) — the stone bearing his footprints, used while raising the Kaaba\'s walls. After Tawaf it is sunnah to pray two rak\'ahs behind it: "Take the standing place of Abraham as a place of prayer." (2:125)', bn: 'ইবরাহীম (আঃ)-এর স্থান — কাবার দেয়াল তোলার সময় ব্যবহৃত পদচিহ্নযুক্ত পাথর। তাওয়াফের পর এর পেছনে দুই রাকাত নামাজ সুন্নাত: "মাকামে ইবরাহীমকে সালাতের স্থান বানাও।" (২:১২৫)' } },
              { term: { en: 'Hijr Ismail', bn: 'হিজরে ইসমাঈল' }, ar: 'حجر إسماعيل', def: { en: 'The semicircular low wall (Hatim) beside the Kaaba. Part of it belongs to the Kaaba, so Tawaf must be performed outside it. Praying within it counts as praying inside the Kaaba (per Aishah RA, Bukhari & Muslim).', bn: 'কাবার পাশে অর্ধবৃত্তাকার নিচু দেয়াল (হাতিম)। এর একাংশ কাবার অন্তর্ভুক্ত, তাই তাওয়াফ এর বাইরে দিয়ে করতে হয়। এর ভেতরে নামাজ পড়া কাবার ভেতরে পড়ার সমতুল্য (আয়িশা রাঃ, বুখারি ও মুসলিম)।' } },
              { term: { en: 'Idtiba & Ramal', bn: 'ইদতিবা ও রামাল' }, ar: 'الاضطباع والرمل', def: { en: 'Two sunnahs for men in the arrival Tawaf: Idtiba — passing the ihram sheet under the right armpit to bare the right shoulder for all seven circuits; Ramal — walking briskly with short steps in the first three circuits.', bn: 'পুরুষদের জন্য আগমনী তাওয়াফের দুই সুন্নাত: ইদতিবা — চাদর ডান বগলের নিচ দিয়ে পরে সাত চক্র ডান কাঁধ উন্মুক্ত রাখা; রামাল — প্রথম তিন চক্রে দ্রুত ছোট পদক্ষেপে হাঁটা।' } },
              { term: { en: 'Ayyam at-Tashreeq', bn: 'আইয়ামে তাশরিক' }, ar: 'أيام التشريق', def: { en: 'The 11th, 12th, and 13th of Dhul-Hijjah, spent in Mina stoning the three Jamarat daily. Fasting is forbidden on these days (except a specific case), and they are days of "eating, drinking, and remembrance of Allah." (Muslim)', bn: '১১, ১২ ও ১৩ জিলহজ, মিনায় প্রতিদিন তিন জামারায় পাথর নিক্ষেপে কাটানো হয়। এই দিনগুলোতে রোজা নিষিদ্ধ (নির্দিষ্ট ব্যতিক্রম ছাড়া), এগুলো "পানাহার ও আল্লাহর স্মরণের দিন।" (মুসলিম)' } },
            ].map(g => `
              <div class="p-3 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-900/40">
                <div class="flex items-center justify-between gap-2 mb-1">
                  <span class="text-sm font-semibold text-indigo-800 dark:text-indigo-200" dir="auto">${L(g.term)}</span>
                  <span class="text-base text-indigo-700 dark:text-indigo-300" dir="rtl">${g.ar}</span>
                </div>
                <p class="text-xs text-indigo-700/90 dark:text-indigo-300/90 leading-relaxed" dir="auto">${L(g.def)}</p>
              </div>`).join('')}
          </div>
        </div>
