        ...
        <div class="rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-5">
          ...
          <div class="space-y-2">
            ${[
              ...
              { q: { en: 'Is zakat due on haram (unlawfully earned) wealth?', bn: 'হারাম উপার্জনের সম্পদে কি যাকাত ফরজ?' }, a: { en: 'No — zakat does not purify haram wealth, for "Allah is pure and accepts only what is pure." (Sahih Muslim 1015). Wealth taken wrongfully must be returned to its rightful owners; if they cannot be traced, scholars rule that the entire amount is given away to the poor or to public benefit — not as reward-earning charity, but simply to be rid of it, together with sincere repentance. Zakat is then calculated only on the person\'s remaining halal wealth.', bn: 'না — যাকাত হারাম সম্পদ পবিত্র করে না, কারণ "আল্লাহ পবিত্র এবং কেবল পবিত্রই গ্রহণ করেন।" (সহীহ মুসলিম ১০১৫)। অন্যায়ভাবে নেওয়া সম্পদ প্রকৃত মালিককে ফেরত দিতে হবে; মালিক খুঁজে না পাওয়া গেলে আলিমদের ফায়সালা: পুরো পরিমাণ গরিব বা জনকল্যাণে দিয়ে দিতে হবে — সওয়াবের দানের নিয়তে নয়, বরং তা থেকে মুক্ত হওয়ার জন্য, সাথে আন্তরিক তওবা। যাকাত কেবল অবশিষ্ট হালাল সম্পদের উপর হিসাব হবে।' } },
              { q: { en: 'Is zakat due on lost, stolen, or inaccessible wealth?', bn: 'হারানো, চুরি যাওয়া বা নাগালের বাইরের সম্পদে কি যাকাত ফরজ?' }, a: { en: 'Wealth you cannot access or realistically recover — lost property, stolen money, a usurped asset, or a denied loan with no proof — is termed "mal dimar" in Hanafi fiqh: no zakat is due while it is out of your control, since zakat presupposes real ownership and ability to dispose. If it is later recovered, the schools differ: the Hanafi and Maliki view waives the missed years (or requires one year only), while the Shafi\'i school requires paying zakat for the past years once recovered. Where views differ, follow reliable local scholarship.', bn: 'যে সম্পদ আপনার নাগালের বা বাস্তব উদ্ধারের বাইরে — হারানো সম্পত্তি, চুরি যাওয়া অর্থ, জবরদখলকৃত সম্পদ বা প্রমাণহীন অস্বীকৃত ঋণ — হানাফি ফিকহে একে "মালে দিমার" বলা হয়: নিয়ন্ত্রণের বাইরে থাকা অবস্থায় যাকাত ফরজ নয়, কারণ যাকাতের জন্য প্রকৃত মালিকানা ও ব্যবহারের ক্ষমতা শর্ত। পরে উদ্ধার হলে মাযহাবগুলোর মতভেদ: হানাফি ও মালিকি মতে বিগত বছরগুলো মাফ (বা কেবল এক বছর), আর শাফিঈ মাযহাবে উদ্ধারের পর বিগত বছরের যাকাত দিতে হবে। মতভেদের ক্ষেত্রে নির্ভরযোগ্য স্থানীয় আলিমের অনুসরণ করুন।' } },
              { q: { en: 'What is the evidence and method for zakat on trade goods (\'urud at-tijarah)?', bn: 'ব্যবসায়িক পণ্যের ("উরুদুত তিজারা") যাকাতের দলিল ও পদ্ধতি কী?' }, a: { en: 'Samurah ibn Jundub (RA) said: "The Messenger of Allah ﷺ used to command us to give sadaqah (zakat) from what we prepared for sale." (Sunan Abu Dawud 1562). Quran 2:267 — "spend from the good things you have earned" — is also cited. Method: on your zakat date, value everything held with the intention of resale at its current market price, add cash and sound receivables, deduct debts currently due, and pay 2.5% if the net reaches the nisab. Fixed business assets — the shop, equipment, vehicles — are exempt.', bn: 'সামুরা ইবনে জুনদুব (রাঃ) বলেন: "রাসূলুল্লাহ ﷺ আমাদের বিক্রয়ের জন্য প্রস্তুত পণ্য থেকে সদকা (যাকাত) দেওয়ার নির্দেশ দিতেন।" (সুনানে আবু দাউদ ১৫৬২)। কুরআন ২:২৬৭ — "তোমাদের উপার্জিত উত্তম বস্তু থেকে ব্যয় করো" — ও দলিল হিসেবে উদ্ধৃত হয়। পদ্ধতি: যাকাত-তারিখে পুনঃবিক্রয়ের নিয়তে রাখা সবকিছু বর্তমান বাজারমূল্যে মূল্যায়ন করুন, নগদ ও নির্ভরযোগ্য পাওনা যোগ করুন, বর্তমানে পরিশোধযোগ্য ঋণ বাদ দিন, নিট পরিমাণ নেসাব পৌঁছালে ২.৫% দিন। স্থায়ী ব্যবসায়িক সম্পদ — দোকান, সরঞ্জাম, যানবাহন — যাকাতমুক্ত।' } },
              { q: { en: 'What does the Quran warn about those who withhold zakat?', bn: 'যাকাত আদায় না করা সম্পর্কে কুরআনে কী সতর্কবাণী আছে?' }, a: { en: 'Quran 9:34-35 warns that those who hoard gold and silver and do not spend in Allah\'s way will have it heated in the Fire of Hell and their foreheads, sides and backs branded with it: "This is what you hoarded for yourselves, so taste what you used to hoard." Quran 3:180 adds that what the miserly withheld "will be wrapped around their necks on the Day of Resurrection." The Prophet ﷺ explained this as the bald poisonous snake coiling around the neck of the one who refused zakat. (Sahih al-Bukhari 1403)', bn: 'কুরআন ৯:৩৪-৩৫ সতর্ক করে: যারা সোনা-রুপা জমা করে এবং আল্লাহর পথে ব্যয় করে না, জাহান্নামের আগুনে তা উত্তপ্ত করে তাদের কপাল, পাঁজর ও পিঠে দাগ দেওয়া হবে: "এটাই তা যা তোমরা নিজেদের জন্য জমা করেছিলে, সুতরাং যা জমা করতে তার স্বাদ নাও।" কুরআন ৩:১৮০ আরও বলে, কৃপণরা যা আটকে রেখেছিল "কিয়ামতের দিন তা তাদের গলার বেড়ি হবে।" নবী ﷺ এটিকে যাকাত-অস্বীকারকারীর গলায় পেঁচানো বিষধর টাক সাপ হিসেবে ব্যাখ্যা করেছেন। (সহীহ বুখারী ১৪০৩)' } },
              { q: { en: 'Can zakat be paid in advance, before the hawl is complete?', bn: 'হাওল পূর্ণ হওয়ার আগে কি অগ্রিম যাকাত দেওয়া যায়?' }, a: { en: 'Yes, according to the majority (Hanafi, Shafi\'i, Hanbali) — once you own the nisab, you may pay a year or even two in advance. Evidence: the Prophet ﷺ accepted the zakat of al-Abbas (RA) in advance before its year had passed. (Sunan Abu Dawud 1624, Tirmidhi 678). The Maliki school does not allow advancing it beyond a short period. Advance payment is useful for emergencies such as famine relief or Ramadan giving; reconcile the exact amount when your hawl date arrives.', bn: 'হ্যাঁ, জমহুরের মতে (হানাফি, শাফিঈ, হানবালি) — নেসাবের মালিক হলে এক বা এমনকি দুই বছরের অগ্রিমও দেওয়া যায়। দলিল: নবী ﷺ আব্বাস (রাঃ)-এর যাকাত বছর পূর্ণ হওয়ার আগে অগ্রিম গ্রহণ করেছিলেন। (সুনানে আবু দাউদ ১৬২৪, তিরমিযী ৬৭৮)। মালিকি মাযহাব সামান্য সময়ের বেশি অগ্রিম অনুমোদন করে না। দুর্ভিক্ষ ত্রাণ বা রমজানের দানের মতো জরুরি প্রয়োজনে অগ্রিম উপকারী; হাওল-তারিখ এলে সঠিক পরিমাণ মিলিয়ে নিন।' } },
              { q: { en: 'Is zakat due on the wealth of a child or a person lacking legal capacity?', bn: 'শিশু বা শরঈ দায়বদ্ধতাহীন ব্যক্তির সম্পদে কি যাকাত ফরজ?' }, a: { en: 'The majority (Maliki, Shafi\'i, Hanbali) hold that zakat attaches to the wealth itself, so the guardian pays it from the property of a child or an insane person once it meets nisab and hawl. Umar (RA) is reported to have said: "Trade with the orphans\' wealth so it is not consumed by zakat." (Muwatta Malik; al-Bayhaqi). The Hanafi school holds that zakat on monetary wealth requires legal responsibility (taklif), so it is not due on them — except zakat al-fitr and the zakat of crops (ushr), which the guardian still pays. Both are established scholarly positions.', bn: 'জমহুর (মালিকি, শাফিঈ, হানবালি) মনে করেন যাকাত সম্পদের সাথেই সম্পৃক্ত, তাই শিশু বা বুদ্ধিহীন ব্যক্তির সম্পদ নেসাব ও হাওল পূর্ণ করলে অভিভাবক তা থেকে যাকাত আদায় করবেন। উমর (রাঃ) থেকে বর্ণিত: "এতিমদের সম্পদ দিয়ে ব্যবসা করো, যাতে যাকাত তা খেয়ে না ফেলে।" (মুয়াত্তা মালিক; বায়হাকি)। হানাফি মাযহাবের মতে আর্থিক সম্পদের যাকাতে শরঈ দায়বদ্ধতা (তাকলিফ) শর্ত, তাই তাদের উপর ফরজ নয় — তবে যাকাতুল ফিতর ও ফসলের উশর অভিভাবক ঠিকই আদায় করবেন। উভয়ই প্রতিষ্ঠিত বিদ্বানী অবস্থান।' } },
            ].map(item => `
