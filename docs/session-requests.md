...
61a. ✅ Enrichment wave 2 (v70): mushaf touch-swipe page turning; audio seek bar + resume-where-you-left; Typing-memorize ayah-range drilling; tajweed explanations tap-toggleable + mobile bottom-sheet rule guide (🎨 pill); cross-module return pill (Sarf → back to Word-Repetition).
61. ✅ Audit-2 landed: 89-agent adversarial audit confirmed **57 bugs + 24 enrichment ideas**; all 57 fixed in one wave (13 parallel fix agents, 20 modules) plus the small enrichments — quiz Practice-missed & mobile-picker fix, ayah-modal prev/next + transliteration + Escape-stack, amal listen/preview + Jumu'ah-from-Thursday, tajweed learned-tracking + RTL guide + show-more, sarf voice/case/gender completeness + bn glosses, root-mode positional highlights & meanings, localized topics letter-bar + batched open-all, vocab verse previews + fair distractors, names/handwriting/arrange/type/mushaf/audio/ponder/settings fixes; 21 new i18n keys ×15 languages. Deployed v69.
